...
from .views import (
    ...
    yuklama_qr_scan_check, yuklama_qr_scan_finalize,
    mahsulot_granularity_review, mahsulot_granularity_apply,
...
urlpatterns = [
    ...
    path('product/<int:mahsulot_id>/granularity/review/', mahsulot_granularity_review, name='mahsulot_granularity_review'),
    path('product/<int:mahsulot_id>/granularity/apply/', mahsulot_granularity_apply, name='mahsulot_granularity_apply'),
    ...
    path('api/yuklama/qr-scan-check/', yuklama_qr_scan_check, name='yuklama_qr_scan_check'),
    path('api/yuklama/qr-scan-finalize/', yuklama_qr_scan_finalize, name='yuklama_qr_scan_finalize'),
